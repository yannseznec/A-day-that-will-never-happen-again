...
int const numDigPinsCC = 1; // number of digital pins to send CC (0 or 127)
...
int touchpin[] = {
  3,4,0,1}; // which digital pins to use as touch pins
  int touchpitch[] = {
...
int outs[numOutputs];
int outPins[] = {
 3,4,13,14,15,16,17,8}; // which digital pins to use as out pins
  int outputpitch[] = {
